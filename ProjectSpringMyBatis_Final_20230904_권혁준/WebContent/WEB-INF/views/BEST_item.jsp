...
<%@ page contentType="text/html;charset=UTF-8" language="java" %>
 <%
	...
	String vURL = request.getContextPath() + "/BEST_item.do";
	...
	ArrayList<ProductDTO> dtoL = (ArrayList<ProductDTO>)request.getAttribute("dtoL");
...
<head>
  <title>PRODUCT - BEST ITEM</title>
  <link rel="stylesheet" href="<%=vUrl + "/resources" + vFile %>">

  <style>
    section {
      width: 100%;
      height: 100%;
      background-image: url('<%=vUrl + "/resources/img/Top_img.PNG"%>');
...
<div id="wrap">
  ...
  <section>
    <div class="notice">
      <h1>&nbsp;&nbsp;&nbsp;&nbsp;RANKING > 권사장 Pick ! BEST ITEM </h1>
