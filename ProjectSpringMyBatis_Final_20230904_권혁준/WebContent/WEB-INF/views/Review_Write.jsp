...
<%
	...
	String vURL = request.getContextPath() + "/Review_write_Proc.do";
%>
<!DOCTYPE html>
<html lang="en">
<meta charset="UTF-8">
...
<div id="wrap">
  ...
  <center>
    <div class="notice">
    <div class="bg_opac">
    <form action="<%=vURL %>" method="post" name="frmRV">
    ...
    <input type="hidden" name="rv_writer" value="<%=session.getAttribute("vId") %>">
      ...
      <table>
        <tr>
          <th colspan="2" class="title" style='height: 5%;'><h3>Review Write</h3></th>
        </tr>

        <tr>
          <td style='width: 100px; height: 10%;'>상품 정보</td>
