...
<%@ page contentType="text/html;charset=UTF-8" language="java" %>
 <%
	...
	String vURL = request.getContextPath() + "/Outer.do";
...
<html lang="en">
    <meta charset="UTF-8">
<head>
    <title>PRODUCT - OUTER</title>
    <link rel="stylesheet" href="<%=vUrl + "/resources/Product_List_ds.css" %>">
    ...
    <section>
        <div class="notice">
            ...
            <form action="<%=request.getContextPath() %>/More_info.do" method="post" id="gueFrm" name="gueFrm">
		      ...
		      <%
		   if (dtoL == null) {
			   response.sendRedirect(request.getContextPath() + "/Outer.do");
